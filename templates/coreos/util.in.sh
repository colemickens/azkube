...
cmd_deploy-addons() {
	cmd_kubectl create -f "https://github.com/colemickens/azkube/tree/${AZKUBE_BRANCH}/templates/coreos/addons/kube-system"
	cmd_kubectl create -f "https://github.com/colemickens/azkube/tree/${AZKUBE_BRANCH}/templates/coreos/addons/skydns.yaml"
	cmd_kubectl create -f "https://github.com/colemickens/azkube/tree/${AZKUBE_BRANCH}/templates/coreos/addons/kube-dashboard.yaml"
}
